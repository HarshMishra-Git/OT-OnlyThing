-- ============================================
-- OT-OnlyThing Complete Database Schema
-- Date: 2025-11-13
-- Version: 1.0.0
-- ============================================
...
CREATE POLICY "Admin can manage product specs"
...
CREATE POLICY "Admin can manage all queries"
  ON customer_queries FOR ALL
  USING (
    EXISTS (
      SELECT 1 FROM profiles
      WHERE profiles.id = auth.uid() AND profiles.role = 'admin'
